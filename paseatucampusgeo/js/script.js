...
"jardin":{latitude:40.4485, longitude: -3.72808}
});
...
monogatari.script({"randommessage":[
	...
	function sitio(monogatari,etiqueta,sitio){
		...
		sitio(monogatari,"pabellon","pabellon");
sitio(monogatari,"vias","vias");
sitio(monogatari,"tilos","tilos");
sitio(monogatari,"plaza","plaza");
sitio(monogatari,"jardin","jardin");
...
"En esta ruta recorrerás 1,5 km aproximadamente",
"show character clara lookright at left with fadeIn end-fadeOut",

"¿Estás listo? ¡Que empezamos! ve a esta dirección",
"call pabellon",
"¡Ya hemos llegado!",
...
"Vayamos hacia las vías antiguas",
"call vias",
"¡Ya hemos llegado!",
