...
function encuesta(monogatari, etiqueta) {
    ...
    elemento[etiqueta] = [
        ...
        "sendaction geoteruelcentro " + etiqueta,
        "return",
    ];
    monogatari.script(elemento);
}
...
monogatari.script({
    Start: [
        ...
        "sendaction geoteruelcentro inicio_encuesta_usuario",
        ...
        "show scene torico1",
        "sendaction geoteruelcentro yendo_torico",
        "call primersitio",
        "sendaction geoteruelcentro llegado_torico",
    ...
    Catedral: [
        ...
        "sendaction geoteruelcentro yendo_catedral",
        "call segundositio",
        "sendaction geoteruelcentro llegado_catedral",
    ...
    Mausoleo: [
        ...
        "sendaction geoteruelcentro yendo_mausoleo",
        "call sextositio",
        "sendaction geoteruelcentro llegado_mausoleo",
        ...
        "sendaction geoteruelcentro inicio_encuesta_modif_mausoleo",
        {
            Choice: {
                ...
                mausoleoModif1No: {
                    Text: "No",
                    Do: "sendaction geoteruelcentro mausoleo_modif1_no",
                    Class: "button2",
                },
            },
        },
        "show scene mausoleomodifizq",
        {
            Choice: {
                ...
                mausoleoModif2Si: {
                    Text: "Sí",
                    Do: "sendaction geoteruelcentro mausoleo_modif2_si",
                    Class: "button1",
                },
                mausoleoModif2No: {
                    Text: "No",
                    Do: "sendaction geoteruelcentro mausoleo_modif2_no",
                    Class: "button2",
                },
            },
        },
        "show scene mausoleomodifambas",
        {
            Choice: {
                ...
                mausoleoIzquierda: {
                    Text: "Izquierda",
                    Do: "sendaction geoteruelcentro mausoleo_modif_izquierda",
                    Class: "button1",
                },
                mausoleoAmbas: {
                    Text: "Ambas",
                    Do: "sendaction geoteruelcentro mausoleo_modif_ambas",
                    Class: "button2",
                },
                mausoleoDerecha: {
                    Text: "Derecha",
                    Do: "sendaction geoteruelcentro mausoleo_modif_derecha",
                    Class: "button3",
                },
            },
        },
